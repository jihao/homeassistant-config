...
def setup(hass, config):
    ...
    def send_message(call):
        ...
        client = rokid_audio(rokid_sn, webhook_id)       
        try:
...
class rokid_audio:
    ...
    def __init__(self, rokid_sn=None, webhook_id=None):     
        ...
        self._audio_url = "https://homebase.rokid.com/trigger/with/{}".format(webhook_id)

    def _text_to_speech(self, text):
        try:
            data = {"type":"audio","devices":{"sn": self._rokid_sn},"data": {"url": text}}
            r = requests.post(self._audio_url, headers=self._headers, json=data)
