...
def setup(hass, config):
    ...
    def send_message(call):
        ...
        client = rokid_asr(rokid_sn, webhook_id)       
        try:
...
class rokid_asr:
    ...
    def __init__(self, rokid_sn=None, webhook_id=None):     
        ...
        self._asr_url = "https://homebase.rokid.com/trigger/with/{}".format(webhook_id)

    def _text_to_speech(self, text):
        try:
            data = {"type":"asr","devices":{"sn": self._rokid_sn},"data": {"text": text}}
            r = requests.post(self._asr_url, headers=self._headers, json=data)
